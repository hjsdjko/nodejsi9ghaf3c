        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"cursor":"pointer","padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px rgba(244,100,130,.3)","margin":"0 2px 5px 0","borderColor":"#fff","color":"#fff","minWidth":"55px","outline":"none","borderRadius":"4px","background":"#00acc1","borderWidth":"0px","width":"auto","fontSize":"inherit","lineHeight":"26px","borderStyle":"solid","height":"auto"}'
                size="small"
